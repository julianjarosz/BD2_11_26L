...
from schema_metadata_store import ColumnMetadata, SchemaMetadataStore, TableSchemaMetadata
from step_raport_generator import StepRaportGenerator
from data_schema_cleaner import CleaningStep
from database_payload import DatabasePayload
from database_types import DatabaseRow
...
class ToPostgreSQLDataSchemaCleaner:
    ...
    def clean_data(
        ...
        return DatabasePayload(
            rows=cleaned_rows, number_of_rows=len(cleaned_rows), request_type=data.request_type
        )
